...
section .bss
    ...
    maior_numero resd 1      ; Armazenar o maior número
...
_start:
    ...
    ; Inicializar o maior número como um valor muito pequeno
    mov dword [maior_numero], -2147483648
...
ler_arquivo:
    ...
    cmp eax, ecx
    jle ler_arquivo            ; Se não for maior, continuar lendo
